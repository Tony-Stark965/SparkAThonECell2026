  ...
  return (
    <footer className="relative w-full border-t border-neutral-900 bg-black overflow-hidden font-mono text-xs text-neutral-300">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-8 md:py-12 lg:py-16">
        {/* --- DESKTOP REDESIGN (Hidden on Mobile) --- */}
        <div className="hidden md:flex flex-row justify-between items-start max-w-5xl mx-auto w-full gap-10 lg:gap-16">
          
          {/* Column 1: Branding */}
          <div className="flex flex-col items-start text-left space-y-5 flex-1 max-w-sm">
            <div className="flex items-center gap-3">
              <span className="h-2.5 w-2.5 rounded-full bg-amber-500 shadow-[0_0_12px_rgba(245,158,11,1)]" />
              <span className="text-2xl lg:text-3xl font-black tracking-widest text-white uppercase drop-shadow-[0_0_15px_rgba(255,255,255,0.15)]">
                {SPARKATHON_CONFIG.name} <span className="text-amber-500">{SPARKATHON_CONFIG.year}</span>
              </span>
            </div>
            <p className="text-xs lg:text-sm tracking-[0.2em] text-neutral-400 uppercase leading-relaxed">
          ...
          {/* Column 2: Contact */}
          <div className="flex flex-col items-start space-y-5 flex-1 max-w-xs">
          ...
          <div className="flex flex-col items-start space-y-5 flex-[0.7]">
            <div className="inline-flex items-center gap-2">
              <span className="h-1 w-1 rounded-full bg-amber-400" />
              <span className="text-xs font-bold tracking-[0.3em] text-amber-400 uppercase">
                CONNECT
            ...
            <div className="flex gap-4">
              {/* Instagram */}
              <a href="https://www.instagram.com/ecellfcrit?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="group relative p-3.5 rounded-xl border border-neutral-800 bg-neutral-900/80 hover:border-amber-500 hover:bg-amber-500/10 transition-all duration-300 shadow-lg hover:shadow-[0_0_15px_rgba(245,158,11,0.4)] flex items-center justify-center h-12 w-12" aria-label="Instagram">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/fcrit-entrepreneurship-cell/" target="_blank" rel="noopener noreferrer" className="group relative p-3.5 rounded-xl border border-neutral-800 bg-neutral-900/80 hover:border-amber-500 hover:bg-amber-500/10 transition-all duration-300 shadow-lg hover:shadow-[0_0_15px_rgba(245,158,11,0.4)] flex items-center justify-center h-12 w-12" aria-label="LinkedIn">
                <svg className="w-5 h-5 text-neutral-400 group-hover:text-amber-400 transition-colors" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="md:hidden grid grid-cols-1 gap-8 items-start">
          ...
          <div className="grid grid-cols-1 gap-8 items-start w-full">
            ...
            <div className="flex items-center gap-3 sm:gap-5">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/fcrit-entrepreneurship-cell/" target="_blank" rel="noopener noreferrer" className="group relative p-3 rounded-full border border-neutral-800 bg-neutral-900/80 hover:border-amber-500 hover:bg-amber-500/10 transition-all duration-300 shadow-lg hover:shadow-[0_0_15px_rgba(245,158,11,0.4)] flex items-center justify-center h-[46px] w-[46px]" aria-label="LinkedIn">
                <svg className="w-5 h-5 text-neutral-400 group-hover:text-amber-400 transition-colors" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
                  <rect x="2" y="9" width="4" height="12"></rect>
                  <circle cx="4" cy="4" r="2"></circle>
